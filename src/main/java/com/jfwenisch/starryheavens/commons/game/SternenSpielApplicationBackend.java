...
import com.jfwenisch.starryheavens.commons.command.PrimaerAktion;
...
public class SternenSpielApplicationBackend {
    ...
    public void setSpielstein(final int x, final int y,
        ...
        //fehler ueberpruefen
        new Thread (new SH_R_SpielUeberpuefen(this)).start();
    ...
    public void startNewSpielFrom(final String spielname, boolean b) throws IOException,
            LoesungswegNichtEindeutigException {
        final Spiel newGame = Spiel.newSpiel(spielname,b);
        setSpiel(newGame);
    }
    ...
    public File saveCurrentPuzzleTo(final String puzzlename) throws IOException {
