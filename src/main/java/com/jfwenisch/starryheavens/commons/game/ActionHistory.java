...
import com.jfwenisch.starryheavens.commons.game.ActionHistoryObject.PathAndStepStatus;
...
//			if(!bHasError)
//				SH_SYSTEM_Animation.getHero().receiveHeal(10, MainFrame.mainPanel.getGraphics());
