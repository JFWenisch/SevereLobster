...
import com.jfwenisch.starryheavens.commons.infrastructure.GlobaleKonstanten;
import com.jfwenisch.starryheavens.commons.infrastructure.ResourceManager;
import com.jfwenisch.starryheavens.commons.infrastructure.StoppUhr;
import com.jfwenisch.starryheavens.commons.infrastructure.enums.SchwierigkeitsgradEnumeration;
import com.jfwenisch.starryheavens.commons.infrastructure.enums.SpielmodusEnumeration;
import com.jfwenisch.starryheavens.commons.system.exceptions.LoesungswegNichtEindeutigException;
...
public class Spiel  implements Serializable{
	...
	public OnlineHighscore score= new OnlineHighscore();
...
//				}
				...
				if(isSolo)
				{
					...
					try {
						resourceManager.setUserProperty(saveName, String.valueOf(Highscore));
					} catch (Exception e) {
						...
						//MainFrame.mainPanel.addSingleplayerView();
				...
				*/
				//////////////////////////////////////////////////////////
				// -> Dialog ausgetauscht durch Panel
				// -> author = fwenisch
				/////////////////////////////////////////////////////////
//				MainFrame.mainPanel.FadeOutImage();
//				MainFrame.mainPanel.addGewonnenPanel(getHighscore(), getSpielZeit(), getAnzahlZuege(),isSolo);
	...
	public int getHighscore() {
		if (spielStoppUhr != null)
		{
			...
			iHighscore=score;
//			this.score=ClientConnector.getHighscore(iHighscore);
		}
	 ...
	 */
	public File saveSpiel(String spielname) throws IOException {
		if (getSpielmodus().equals(SpielmodusEnumeration.SPIELEN)) {
	...
	public static Spiel newSpiel(String strPuzzleName, boolean b) throws IOException, LoesungswegNichtEindeutigException {
		XStream xstream = new XStream(new DomDriver());
